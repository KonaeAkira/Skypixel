package com.github.konaeakira.skypixel.quicknav;
...
public class QuickNav {
    public static List<QuickNavButton> init(String title, int left_x, int right_x, int top_y, int bottom_y) {
        ...
        buttons.add(new QuickNavButton(left_x + 29 * 1, bottom_y, QuickNavButton.Type.BOTTOM, false, "/warp dungeon_hub", new ItemStack(Items.NETHER_STAR)));
